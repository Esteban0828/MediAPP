...
$(document).ready(function() {
        ...
        apiKey: "AIzaSyAcI46KcLQfjAOz1vqf2C35Q6nLVCbtAs8",
        authDomain: "bdmedi-64262.firebaseapp.com",
        databaseURL: "https://bdmedi-64262-default-rtdb.firebaseio.com",
        projectId: "bdmedi-64262",
        storageBucket: "bdmedi-64262.appspot.com",
        messagingSenderId: "46751284857",
        appId: "1:46751284857:web:895e17690c740146a81ea8"
    };    
    ...
    coleccionProductos.on("child_added", datos => {        
        dataSet = [datos.key, datos.child("nombre").val(), datos.child("caducidad").val()];
    ...
    $('form').submit(function(e){                         
        ...
        let caducidad = $.trim($('#caducidad').val());                         
        let idFirebase = id;        
        if (idFirebase == ''){                      
            idFirebase = coleccionProductos.push().key;
        };                
        data = {nombre:nombre, caducidad:caducidad};             
        actualizacionData = {};
    ...
    $("#tablaProductos").on("click", ".btnEditar", function() {    
        ...
        let caducidad = parseInt($(this).closest('tr').find('td:eq(1)').text());        
        $('#id').val(id);        
        // $('#codigo').val(codigo);
        $('#nombre').val(nombre);                
